...
BLOG_AUTHOR = "Luke Petschauer"  # (translatable)
BLOG_TITLE = "Luke writes about coding (mostly)"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://lukewrites.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://lukewrites.github.io/"
BLOG_EMAIL = "luke.petschauer@me.com"
BLOG_DESCRIPTION = "Python and Django and testing - oh my!"  # (translatable)
